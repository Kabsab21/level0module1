...
def mouse_pressed(event):
    ...
    canvas.create_oval(x - 80, y + 80, x + 80, y + 220, fill="red")
    canvas.create_oval(x - 50, y + 80, x + 50, y + 180, fill="orange")
    canvas.create_oval(x - 20, y + 80, x + 20, y + 140, fill="yellow")
